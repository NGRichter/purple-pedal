...
#define HID_GAMEPAD_REPORT_DESC() {				\
	...
	HID_COLLECTION(HID_COLLECTION_APPLICATION),	\
			...
			HID_FEATURE(0x02), \
			/* Preset Name Slot 6*/ \
			HID_REPORT_ID(GAMEPAD_FEATURE_REPORT_SLOT_NAME_SLOT6_ID), \
			HID_USAGE(0x25), \
			HID_LOGICAL_MIN8(0x00), \
			HID_LOGICAL_MAX16(0xff, 0x00), \
			HID_REPORT_SIZE(8), \
			...
			HID_FEATURE(0x02), \
			/* Preset Name Slot 7*/ \
			HID_REPORT_ID(GAMEPAD_FEATURE_REPORT_SLOT_NAME_SLOT7_ID), \
			HID_USAGE(0x25), \
			HID_LOGICAL_MIN8(0x00), \
			HID_LOGICAL_MAX16(0xff, 0x00), \
			HID_REPORT_SIZE(8), \
			...
			HID_FEATURE(0x02), \
			/* Preset Name Slot 8*/ \
			HID_REPORT_ID(GAMEPAD_FEATURE_REPORT_SLOT_NAME_SLOT8_ID), \
			HID_USAGE(0x25), \
			HID_LOGICAL_MIN8(0x00), \
			HID_LOGICAL_MAX16(0xff, 0x00), \
			HID_REPORT_SIZE(8), \
			...
			HID_FEATURE(0x02), \
			/* Preset Name Slot 9*/ \
			HID_REPORT_ID(GAMEPAD_FEATURE_REPORT_SLOT_NAME_SLOT9_ID), \
			HID_USAGE(0x25), \
			HID_LOGICAL_MIN8(0x00), \
			HID_LOGICAL_MAX16(0xff, 0x00), \
			HID_REPORT_SIZE(8), \
			...
			HID_FEATURE(0x02), \
			/* Preset Name Slot 10*/ \
			HID_REPORT_ID(GAMEPAD_FEATURE_REPORT_SLOT_NAME_SLOT10_ID), \
			HID_USAGE(0x25), \
			HID_LOGICAL_MIN8(0x00), \
			HID_LOGICAL_MAX16(0xff, 0x00), \
			HID_REPORT_SIZE(8), \
